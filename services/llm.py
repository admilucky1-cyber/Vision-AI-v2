...
def ask_ai(question: str, context: str = "", backend: str = "auto") -> str:
    ...
    # Optional Colab GPU worker (stronger free models while session is live)
    try:
        from services.colab_worker import is_enabled as _colab_on, chat as _colab_chat
        if _colab_on() and backend in ("auto", "colab"):
