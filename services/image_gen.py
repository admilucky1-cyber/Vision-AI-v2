...
def clean_image_prompt(raw: str) -> str:
    ...
    if any(
        ...
        return (
            f"{p}, photorealistic architectural photography, accurate building geometry, "
            f"natural lighting, coherent scene, no abstract symbols, no medical diagrams, "
            f"no circular scientific charts, matches the prompt exactly"
        )
