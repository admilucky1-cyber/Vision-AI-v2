...
class SmartImageRouter:
    """Colab worker → HuggingFace Inference → Pollinations."""
    ...
    async def generate(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if _colab_on():
                ...
                if got and got.get("success"):
                    ...
                    got.setdefault("provider", "Colab GPU")
                    return got
        except Exception as e:
            logger.warning("SmartImageRouter Colab: %s", e)

        # 2) RunPod if configured
        try:
            ...
            if _rp_on():
                ...
                if got and got.get("success"):
                    ...
                    got.setdefault("provider", "RunPod")
                    return got
        except Exception as e:
        ...
        try:
            ...
            if got and got.get("success"):
                ...
                got.setdefault("provider", "Pollinations")
                return got
        except Exception as e:
        ...
        return {
            "success": False,
            "error": "No image provider available. Start Colab Boost, set HF_TOKEN, or try again later.",
            "url": None,
        }
