...
def worker_image(body: ImageIn, x_worker_secret: Optional[str] = Header(None)):
    ...
    # Prefer exact user intent — light quality suffix only
    ...
    # Optional local path: IMAGE_MODEL_PATH=/content/models/xxx or Drive copy
    local_path = (os.getenv("IMAGE_MODEL_PATH") or "").strip()
