...
async def serve_downloaded_file(
    ...
    # Force generic binary so mobile browsers save instead of inline-play
    media_type = "application/octet-stream" if dl else mime_map.get(ext, "application/octet-stream")
