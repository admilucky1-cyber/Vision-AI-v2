...
async def serve_downloaded_file(filename: str):
    ...
    Mobile browsers often ignore weak disposition; we set attachment +
    RFC 5987 filename* and correct MIME so Android/iOS trigger a save.
    """
    import re as _re
    ...
    # ASCII fallback + UTF-8 filename* for non-ascii names
    ...
    return FileResponse(
        ...
        headers={
            ...
            "Accept-Ranges": "bytes",
            # Help some mobile browsers treat as download not inline play
