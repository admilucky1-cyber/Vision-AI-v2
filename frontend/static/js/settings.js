// ============================================================
// VISION AI v2.0 - SETTINGS LOGIC (Production Ready)
// ============================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('👁️ Vision AI Settings v2.0 - Ready');
});
...
(function loadAbout(){
  function run(){
    ...
    fetch('/api/version').then(r => r.json()).then(d => {
      if (v) v.textContent = d.version || d.current || '3.1.0';
    ...
    }).catch(() => { if (v) v.textContent = '3.1.0 (offline meta)'; });
