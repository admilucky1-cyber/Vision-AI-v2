...
function renderUserProfile() {
    ...
    if (!userData.username) {
        footer.innerHTML = `
            <button type="button" class="sidebar-link" onclick="downloadCurrentChat()" title="Download this chat as text">Download chat</button>
            <a href="/login.html" class="sidebar-link" style="display:flex;align-items:center;justify-content:center;width:100%;padding:10px 12px;background:linear-gradient(135deg, #00C6FF, #7B68EE);color:#fff;border-radius:10px;text-decoration:none;font-weight:600;font-size:14px;gap:8px;margin-top:8px;">
                Sign In
            </a>
        `;
        return;
    ...
    footer.innerHTML = `
        <button type="button" class="sidebar-link" onclick="downloadCurrentChat()" title="Download this chat as text" style="margin-bottom:8px;">Download chat</button>
