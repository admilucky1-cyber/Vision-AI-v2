...
function renderUserProfile() {
    ...
    const downloadBtn = '<button type="button" class="sidebar-link footer-dl" onclick="downloadCurrentChat()" title="Download this chat as text">Download chat</button>';

    if (!userData.username) {
        footer.innerHTML = downloadBtn + `
