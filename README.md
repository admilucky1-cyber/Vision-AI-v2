...
[![Version](https://img.shields.io/badge/version-3.2.8-brightgreen)](VERSION)
...
| Version | Summary |
|---------|---------|
| **3.2.8** | **Complete** exam-solve release (cache module + full smoke + checklist) |
...
## Exam solve reliability stack (v3.1.0 → v3.2.8)
...
1. Unzip **VISION-AI-v3.2.8-FINAL.zip**
