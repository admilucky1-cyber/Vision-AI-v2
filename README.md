...
[![Version](https://img.shields.io/badge/version-2.7.0-brightgreen)](VERSION)
...
See `QUICKSTART.md`, `DEPLOY.md`, `GITHUB.md`, `OAUTH_GOOGLE.md`, `COLAB_DRIVE_CACHE.md`.
...
|---------|--------|-------|
| **2.7.0** | current | Mobile overlay fix, responsive chips/buttons, chat UI refresh, free-tier bar |
| 2.6.1 | prior | Mobile layout, extended chat timeouts, Colab secrets stability, OAuth harden |
| 2.6.0 | prior | GPU-first images, unified version, production FINAL baseline |
