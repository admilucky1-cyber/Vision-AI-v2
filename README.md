...
[![Version](https://img.shields.io/badge/version-3.2.0-brightgreen)](VERSION)
...
| Version | Summary |
|---------|---------|
| **3.2.0** | **Complete** exam-solve release (cache module + full smoke + checklist) |
...
## Exam solve reliability stack (v3.1.0 → v3.2.0)
...
1. Unzip **VISION-AI-v3.2.0-FINAL.zip**
