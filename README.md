...
[![Version](https://img.shields.io/badge/version-2.8.9-brightgreen)](VERSION)
...
| Version | Notes |
|---------|--------|
| **2.8.9** | Plans width, chat chrome, profile menu, README, stop/composer polish |
