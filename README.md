...
[![Version](https://img.shields.io/badge/version-3.0.5-brightgreen)](VERSION)
...
- Exact version in browser title + About + `/api/version`
- Student plan in payment dropdown; theme bootstrap site-wide
- User messages on the right; hamburger/focus unfreeze
- Expanded free OpenRouter + Groq models (large context)
- Stronger VISION AI identity (version, PKT time awareness)
