...
[![Version](https://img.shields.io/badge/version-2.7.4-brightgreen)](VERSION)
...
|---------|--------|-------|
| **2.7.4** | current | Mobile overlay fix, responsive chips/buttons, chat UI refresh, free-tier bar |
| 2.7.4 | prior | Mobile layout, extended chat timeouts, Colab secrets stability, OAuth harden |
| 2.7.4 | prior | GPU-first images, unified version, production FINAL baseline |
