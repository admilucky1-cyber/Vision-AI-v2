...
[![Version](https://img.shields.io/badge/version-2.6.2-brightgreen)](VERSION)
...
See `QUICKSTART.md`, `DEPLOY.md`, `GITHUB.md`, `OAUTH_GOOGLE.md`.
...
|---------|--------|-------|
| **2.6.2** | current | Mobile overlay fix, responsive chips/buttons, chat UI refresh, free-tier bar |
