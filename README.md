...
[![Version](https://img.shields.io/badge/version-2.6.3-brightgreen)](VERSION)
...
|---------|--------|-------|
| **2.6.3** | current | Mobile overlay fix, responsive chips/buttons, chat UI refresh, free-tier bar |
