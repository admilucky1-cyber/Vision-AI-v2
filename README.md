...
[![Version](https://img.shields.io/badge/version-3.2.4-brightgreen)](VERSION)
...
| Version | Summary |
|---------|---------|
| **3.2.4** | **Complete** exam-solve release (cache module + full smoke + checklist) |
...
## Exam solve reliability stack (v3.1.0 → v3.2.4)
...
1. Unzip **VISION-AI-v3.2.4-FINAL.zip**
