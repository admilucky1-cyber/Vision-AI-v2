...
APP_VERSION = (BASE_DIR / "VERSION").read_text(encoding="utf-8").strip() if (BASE_DIR / "VERSION").exists() else "3.8.0"
...
# login routes: direct_auth_* in main.py + remaining via include below
